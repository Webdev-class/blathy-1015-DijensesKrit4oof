...
test('modifyCustomer test 1',() => {
    expect(modifyCustomer({id:2, name:"Fülöp Ézli", age:43, address:{city:"Hingatungan", street:"3 Farwell Lane", house:148}, newsLetter: true}))
    .toEqual(t1)
})
...
test('removeCustomer test 3',() => {
    expect(modifyCustomer({id:10, name:"Jonas Tungate", age:83, address:{city:"Budapest", street:"224 Manley Drive", house:49}, newsLetter: false}))
    .toEqual(t3)
})